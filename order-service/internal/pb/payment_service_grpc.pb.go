...
const (
	PaymentService_CreatePayment_FullMethodName = "/PaymentService/CreatePayment"
	PaymentService_Pay_FullMethodName           = "/PaymentService/Pay"
	PaymentService_QueryPayment_FullMethodName  = "/PaymentService/QueryPayment"
)
...
type PaymentServiceClient interface {
	// 创建支付订单
	// 输入：CreatePaymentRequest - 创建支付请求参数
	// 输出：CreatePaymentResponse - 创建支付响应结果
	CreatePayment(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*CreatePaymentResponse, error)
	// 执行支付操作
	// 输入：PayRequest - 支付请求参数
	// 输出：PayResponse - 支付响应结果
	Pay(ctx context.Context, in *PayRequest, opts ...grpc.CallOption) (*PayResponse, error)
	// 查询支付状态
	// 输入：QueryPaymentRequest - 查询支付请求参数
	// 输出：QueryPaymentResponse - 查询支付响应结果
