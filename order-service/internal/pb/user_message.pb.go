...
const file_user_message_proto_rawDesc = "" +
	"\n" +
	"\x12user_message.proto\"6\n" +
	"\x18GetUserByUsernameRequest\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\"Y\n" +
	"\x0fGetUserResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword2O\n" +
	"\vUserService\x12@\n" +
	"\x11GetUserByUsername\x12\x19.GetUserByUsernameRequest\x1a\x10.GetUserResponseB\x12Z\x10./internal/pb;pbb\x06proto3"
...
var file_user_message_proto_goTypes = []any{
	(*GetUserByUsernameRequest)(nil), // 0: GetUserByUsernameRequest
	(*GetUserResponse)(nil),          // 1: GetUserResponse
}
var file_user_message_proto_depIdxs = []int32{
	0, // 0: UserService.GetUserByUsername:input_type -> GetUserByUsernameRequest
	1, // 1: UserService.GetUserByUsername:output_type -> GetUserResponse
